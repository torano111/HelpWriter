...
class EASYFILEDIALOG_API UEFDFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	// Save File Dialog (Raw version)
	UFUNCTION(BlueprintCallable, Category = "EasyFileDialog")
	static bool SaveFileDialogRaw(const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, EEasyFileDialogFlags Flags, TArray< FString >& OutFilenames);
